...
<script>
        $( function() {
            ...
            hueb.on( 'change', function( color, hue, sat, lum ) {
                $.get('<?php echo e(route('titlecolour')); ?>', {color}, function(data) {
            ...
            var availableTags = <?php echo json_encode(App\Application::all()->pluck('name'), 15, 512) ?>;
            ...
            function appload(appvalue) {
                if(appvalue == 'None') {
                    ...
                    $.post('<?php echo e(route('appload')); ?>', { app: appvalue }, function(data) {
                        // Main details
